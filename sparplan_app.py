...
###Werbung
    with col2_2:
        ...
        url_neu = 'https://www.financeads.net/tc.php?t=19947C274449896B'    
        link = pd.DataFrame(['<a href="' +url_neu+ '" target="_blank"><img src="https://etf-blog.com/wp-content/uploads/2020/10/trade_republic_sparplan_klein.png" width="145" ></a>'], columns=[''])
